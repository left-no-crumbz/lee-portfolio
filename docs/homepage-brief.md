...
Mode: Experience. Target: src/App.tsx and src/styles.css.
Audience: recruiters evaluating broad aeronautical engineering capability.
Approved composition: Engineering Sequence's identity-led opening, Evidence Concourse's scan-friendly project index, and Design / Build / Validation inside the featured UAV project.
